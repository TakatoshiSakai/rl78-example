...
* Description  : This file implements system initialising function.
...
* Description  : This function initialises every peripherals used in this demo.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
